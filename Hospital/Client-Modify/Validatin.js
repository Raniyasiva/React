...
export default function Validatin() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (formvalues) => {
      ...
      if (rowData) {
       const updateResponse=  await axios.put(`http://localhost:3000/updateUserData/${rowData.id}`, formDataToSend);
       console.log(rowData);
    ...
    formik.resetForm();
        ...
        const response=  await axios.post('http://localhost:3000/storeUserData', formDataToSend);
                ...
                <div className="btn-file">
                  <label htmlFor="file-upload" className="btn-file">
                    ...
                    <Typography
                      className="reg"
                     >
                      {selectedFile ? selectedFile.name: rowData && rowData.file? rowData.file: "Registration Certificate"}
                      <GoUpload
                        color="primary"
                        fontSize="small"
                        className="GoUpload"
